...
Ext.override(Ext.grid.GridPanel, {
	exportToExcel: function(includeHidden, onlySelection, sheetName) {
		if(Ext.isIE || Ext.checkBrowser(/msie 10/) || Ext.checkBrowser(/rv:11/)) {
			try {
				this.exportExcelIE(includeHidden, onlySelection, sheetName)
				 ...
				 Ext.MessageBox.show({
		           title: '信息提示',
		           msg: '请按照描述操作：<br>1、工具->Internet选项->安全->受信任站点->站点->添加。<br>2、选择自定义级别->ActiveX控件和插件->对未标记为安全执行脚本的ActiveX...->启用。',
